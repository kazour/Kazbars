...
| `src/kazbars/build_action.py` | 321 |
...
| `src/kazbars/cast_timer_panel.py` | 295 |
...
| `src/kazbars/deeps_settings.py` | 353 |
...
| `tests/test_grids_generator.py` | 525 |
