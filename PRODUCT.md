...
- **Keyboard.** The editor is mouse-first today. Power users (the small returning audience) benefit from keyboard navigation through grid lists and dialog forms; treat it as a quality target rather than a launch blocker.
